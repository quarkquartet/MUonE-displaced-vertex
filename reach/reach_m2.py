...
tracker_result_path = "./reach_m2_" + sys.argv[1] + "GeV.csv"

print("Calculating sensitivities, file are written in " + tracker_result_path)
    ...
    for mass in mass_list:
        ...
        for coupling in coupling_list:
            ...
            for i in range(0, len(event_list)):
                ...
                if (
                    1.0 * theta_X <= Radius  # dark photon within the angle range
                    and L_min <= d_A <= L_max  # decay in volume
                    and e_mu >= E_cut  # minimal energy
                    and e_e >= E_cut  # minimal energy
                    and 1.0 * theta_mu <= Radius  # angular accpetance
                    and 1.0 * theta_e <= Radius  # angular acceptance
                ):
...
print(
    "Calculation for requirment of pass through three trackers are finished. Now calculating for the ECAL requirement..."
)
